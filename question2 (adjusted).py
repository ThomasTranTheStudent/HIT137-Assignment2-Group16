...
def save_results(largest_range_stations, warmest_stations, coolest_stations):
    ...
    print("The largest temperature range saved to 'largest_temp_range_stations.txt'")
    ...
    with open('warmest_and_coolest_station.txt', 'w') as f:
        ...
        for _, row in coolest_stations.iterrows():
            f.write(f"{row['STATION_NAME']}: {row['ANNUAL_AVG']:.2f} °C\n")
    print("The warmest and coolest station/stations saved to 'warmest_and_coolest_station.txt'")
